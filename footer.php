...
<div class="reply">
	<div class="reply__body">
		...
		<?php echo do_shortcode('[contact-form-7 id="190" title="Форма вопросов"]'); ?>
		<!-- <form action="#">
...
<footer>
	<div class="container">
		<div class="row align-items-center">
			...
			<div class="col-md-4 col-lg-3">
				<div class="footer__social">
					...
					<a href="<?php the_field('insta', 2); ?>" class="footer__social-item">
					...
					<a href="<?php the_field('yout', 2); ?>" class="footer__social-item">
		...
		<div class="col-12">
			...
			</div>  не добавлется кастомный класс  -->
			<a href="http://localhost/childhood/privacy-policy" class="footer__policy">Политика конфиденциальности</a>
            </div>
		</div>

...
<div class="contacts">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="title contacts__minititle"><?php the_field('contacts_title_1'); ?></div>
			...
			<div class="col-md-6">
				<div class="title contacts__minititle"><?php the_field('contacts_title_2'); ?></div>
